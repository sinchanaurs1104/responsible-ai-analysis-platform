...
import { fairnessRangeHint } from "../../api/fairnessMetricInfo";
...
export default function FairnessSection({ fairness, finding }) {
    ...
    <section className="analysis-section">
      ...
      <div className="fairness-scale">
        ...
        <div className="fairness-scale__caption">
          ...
          <br />
          <span className="fairness-scale__range">{fairnessRangeHint("statistical_parity_difference")}</span>
        </div>
      </div>
      ...
      <div className="metric-grid">
        ...
        <Metric
          ...
          value={fmtRatio(fairness.disparate_impact_ratio)}
          hint={fairnessRangeHint("disparate_impact_ratio")}
        />
        <Metric
          label="Equal opportunity diff."
          value={fmtNum(fairness.equal_opportunity_difference)}
          hint={fairnessRangeHint("equal_opportunity_difference")}
        />
        <Metric
          label="Average odds diff."
          value={fmtNum(fairness.average_odds_difference)}
          hint={fairnessRangeHint("average_odds_difference")}
        />
        <Metric label="Theil index" value={fmtNum(fairness.theil_index)} hint={fairnessRangeHint("theil_index")} />
      </div>
    </section>
  );
}
